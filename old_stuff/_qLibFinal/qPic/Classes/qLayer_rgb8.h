...
namespace qLib
{
    ...
    * class qLayerRgb8
    *******************************************************************************/
    class qLayerRgb8 :  public qLayerBase
	{
		private:
		...
		public:
            ...
            virtual unique_ptr<qLayerBase>	CreateClone(bool    _bSameLayerID,
                                                        bool    _bCopyLayerData) const override;

            // clone: same LayerID's, empty Layers because of different size
            virtual unique_ptr<qLayerBase>	CreateCloneSwapWH(bool _bSameLayerID) const override;
        ...
        *******************************************************************************/
		public:
            virtual void					Pixel(s32       _s32X,
                                                  s32       _s32Y,
                                                  qColor    &_col) const override;

            virtual void                    SetPixel(s32            _s32X,
                                                     s32            _s32Y,
                                                     const qColor   &_col) override;
