...
namespace qLib
{
    ...
    *******************************************************************************/
    ...
    : qLayerBase(enumLayerType::Rgb_8, _rctLayer),
    ...
    *******************************************************************************/
    qLayerRgb8::qLayerRgb8(s32  _s32X,
                           ...
                           s32	_s32W,
                           s32  _s32H)
    : qLayerBase(enumLayerType::Rgb_8, qRect2D<s32> (_s32X, _s32Y, _s32W, _s32H)),
    ...
    *******************************************************************************/
    qLayerRgb8::qLayerRgb8(s32  _s32W,
                           s32	_s32H)
    : qLayerBase(enumLayerType::Rgb_8, qRect2D<s32> (0, 0, _s32W, _s32H)),
      m_pR(new qChannel<u8> (_s32W, _s32H)),
      m_pG(new qChannel<u8> (_s32W, _s32H)),
      m_pB(new qChannel<u8> (_s32W, _s32H)),
      m_pA(new qChannel<u8> (_s32W, _s32H))
    ...
    *******************************************************************************/
    unique_ptr<qLayerBase> qLayerRgb8::CreateClone(bool    _bSameLayerID,
                                                   bool    _bCopyData) const
    {
        unique_ptr<qLayerRgb8>	pNew = make_unique<qLayerRgb8> (GetGeometry());
    ...
    *******************************************************************************/
    unique_ptr<qLayerBase> qLayerRgb8::CreateCloneSwapWH(bool    _bSameLayerID) const
    {
    ...
    *******************************************************************************/
    void qLayerRgb8::Pixel(s32      _s32X,
                           ...
                           qColor   &_col) const
    {
        s32		s32OS = _s32Y * GetGeometry().w + _s32X;

        _col.SetRgba(static_cast<Rgba_t> (m_pR->m_pData[s32OS]) / 0xff,
    ...
    *******************************************************************************/
                              ...
                              const qColor   &_cola)
    {
        ...
        m_pR->m_pData[s32OS] = static_cast<u8> (_cola.r * 0xff);
        m_pG->m_pData[s32OS] = static_cast<u8> (_cola.g * 0xff);
        m_pB->m_pData[s32OS] = static_cast<u8> (_cola.b * 0xff);
        m_pA->m_pData[s32OS] = static_cast<u8> (_cola.a * 0xff);
    } // qLayerRgb8::SetPixel
