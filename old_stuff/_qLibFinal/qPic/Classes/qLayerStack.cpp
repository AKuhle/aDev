...
//    } // qLayerStack::qLayerStack
    ...
    *******************************************************************************/
                                                     ...
                                                     bool   _bCopyImageData) const
    {
        ...
        for (const unique_ptr<qLayerBase> &pLayer : *this)
        {
    ...
    *******************************************************************************/
    void qLayerStack::AddLayer(unique_ptr<qLayerBase> _pLayer)
    {
    ...
    *******************************************************************************/
    qLayerBase* qLayerStack::FindLayer(u32   _u32LayerID)
    {
        for (const unique_ptr<qLayerBase> &pLayer : *this)
        {
            if (pLayer->GetId() == _u32LayerID)
                return pLayer.get();
        }
