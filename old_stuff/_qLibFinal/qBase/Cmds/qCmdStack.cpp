...
namespace qLib
{
    ...
    *******************************************************************************/
    void qCmdStack::ExecuteCmd(unique_ptr<qCmdBase> _pCmd)
    {
...
////        m_pSelectedSnapshot = nullptr;
    ...
    * qCmdStack::SetCmd
    *******************************************************************************/
    void qCmdStack::SetCmd(unique_ptr<qCmdBase> _pCmd)
    {
        CHECK_PRE_CONDITION_VOID(_pCmd != nullptr);
...
//        m_pSelectedSnapshot = nullptr;
    ...
    /*******************************************************************************
    * qCmdStack::GetActiveCmd
    *******************************************************************************/
    qCmdBase* qCmdStack::GetActiveCmd() const
    {
...
//    } // qCmdStack::SelectSnapshot
    ...
    * qCmdStack::UndoList
    *******************************************************************************/
    const qUniquePtrList<qCmdBase>& qCmdStack::UndoList() const
    {
        return m_lstUndo;
    } // qCmdStack::UndoList
    ...
    * qCmdStack::RedoList
    *******************************************************************************/
    const qUniquePtrList<qCmdBase>& qCmdStack::RedoList() const
    {
        return m_lstRedo;
    } // qCmdStack::RedoList
    ...
    *******************************************************************************/
    bool qCmdStack::CanUndo() const
    {
        return /*m_pSelectedSnapshot == nullptr &&*/
               m_lstUndo.size() > 0 &&
               m_lstUndo.back()->GetCmdType() == enumCmdType::CMD_TYPE_UNDO;
    } // qCmdStack::CanUndo
...
//    } // qCmdStack::JumpToCmd
    ...
    * handler
    *******************************************************************************/
    void qCmdStack::OnUndoDone(qCmdBase* /*_pCmd*/) {}
    void qCmdStack::OnUndoFailed(qCmdBase* /*_pCmd*/) {}

    void qCmdStack::OnRedoDone(qCmdBase* /*_pCmd*/) {}
    void qCmdStack::OnRedoFailed(qCmdBase* /*_pCmd*/) {}
            ...
            case enumCmdMsg::Undo:
            {
                ...
                if (_pCmd == m_lstUndo.back().get())
                {
                    if (_bSuccess)
                    {
                        ...
                        unique_ptr<qCmdBase> pCmd = m_lstUndo.GetAndPopBack();
            ...
            case enumCmdMsg::Redo:
            {
                ...
                if (_pCmd == m_lstRedo.back().get())
                {
                    if (_bSuccess)
                    {
                        ...
                        unique_ptr<qCmdBase> pCmd = m_lstRedo.GetAndPopBack();
