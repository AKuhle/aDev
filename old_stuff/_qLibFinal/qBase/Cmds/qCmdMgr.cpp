...
namespace qLib
{
    ...
    * qCmdMgr::ExecuteCmd
    *******************************************************************************/
    void qCmdMgr::ExecuteCmd(unique_ptr<qCmdBase> _pCmd)
    {
    ...
    * qCmdMgr::TakeCmdCtrl
    *******************************************************************************/
    unique_ptr<qCmdBase> qCmdMgr::TakeCmdCtrl(qCmdBase *_pCmd)
    {
        unique_ptr<qCmdBase> pCmd = m_lstCmds.FindAndRemove(_pCmd);
    ...
    * handler
    *******************************************************************************/
    void qCmdMgr::OnCmdProcessingStart(qCmdBase */*_pCmd*/) {}
    void qCmdMgr::OnCmdProcessingEnd(qCmdBase */*_pCmd*/) {}

    void qCmdMgr::OnPrepareDone(qCmdBase */*_pCmd*/) {}
    void qCmdMgr::OnPrepareFailed(qCmdBase */*_pCmd*/) {}

    void qCmdMgr::OnDoDone(qCmdBase */*_pCmd*/) {}
    void qCmdMgr::OnDoFailed(qCmdBase */*_pCmd*/) {}
