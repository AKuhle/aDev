...
{
    /*******************************************************************************
    * qLayerStack::LoadFromFile
    *******************************************************************************/
    bool qLayerStack::LoadFromFile(const qString16 &_sFileName)
        ...
        if (bSuccess)
        {
            ...
            switch (eLayerType)
            {
                ...
                case enumLayerType::Rgb_8:
                {
                    ...
                    unique_ptr<qLayerRgb8>  pLayer = make_unique<qLayerRgb8> (w(), h());
                    QColor                  col;
                    s32                     x, y;
