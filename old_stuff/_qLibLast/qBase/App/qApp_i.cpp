...
namespace qLib
{
    ...
    * global variables
    *******************************************************************************/
    qAppI	*qAppI::g_pApp	{ nullptr };


    /*******************************************************************************
    * qAppI::qAppI
    *******************************************************************************/
    qAppI::qAppI(const qVersion	&_version)
    : m_version(_version)
	{
        g_pApp = this;
    ...
    /*******************************************************************************
    * qAppI::DoCreateFromMain
    *******************************************************************************/
    int qAppI::DoCreateFromMain(int		_argc,
                                char		*_argv[],
                                char		**_envp)
	{
    ...
    * qAppI::ParseArgs
    *******************************************************************************/
    void qAppI::ParseArgs(int		/*_argc*/,
                          char		*_argv[],
                          char		** /*_envp*/)
    {
//        int			i;
...
//        //m_argument.GetValue(ARG_VERBOSE, m_s16VerboseLevel);
    ...
    /*******************************************************************************
    * qAppI::ShowVersionInfo
    *******************************************************************************/
//    void qAppI::ShowVersionInfo()
//    {
//        cout << endl;
...
//    } // qAppI::ShowVersionInfo
    ...
    /*******************************************************************************
    * qAppI::ShowProgramHelp
    *******************************************************************************/
//    void qAppI::ShowProgramHelp()
//    {
...
//        aArgument::ArgReport("Example:", "qAppI.exe 17 1.9 arg44 --verbose=1 --list=1,2,3");
//    } // qAppI::ShowProgramHelp
