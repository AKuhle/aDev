...
: qTool(_pOwnerView, _u32ToolId, _u64ToolBaseFunction)
{
} // ToolBase::ToolBase
                                 ...
                                 const qVector2D<s32>   &/*_v2dGlobal*/)
{
    ...
    if (BitsSet(ToolBaseFunction(), TBF_WHEEL_ZOOM))
    {
