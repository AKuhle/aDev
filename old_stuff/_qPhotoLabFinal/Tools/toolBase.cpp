...
: qToolBase(_pOwnerView, _u32ToolId, _u64ToolBaseFunction)
{
} // ToolBase::ToolBase
...
/*******************************************************************************
* ToolBase::GetOwnerView
*******************************************************************************/
const ViewBase* ToolBase::GetOwnerView() const
{
    return dynamic_cast<const ViewBase *> (GetOwnerWin());
} // ToolBase::GetOwnerView
...
* ToolBase::GetOwnerView
*******************************************************************************/
ViewBase* ToolBase::GetOwnerView()
{
    return dynamic_cast<ViewBase *> (GetOwnerWin());
} // ToolBase::GetOwnerView
...
* ToolBase::GetOwnerLS
*******************************************************************************/
shared_ptr<qLayerStack> ToolBase::GetOwnerLS() const
{
    const ViewBase *pView = ToolBase::GetOwnerView();
    CHECK_PRE_CONDITION(pView != nullptr, nullptr);

    return pView->GetLayerStack();
} // ToolBase::GetOwnerLS
...
{
    ViewBase *pView  = GetOwnerView();
    CHECK_PRE_CONDITION(pView != nullptr, enumToolResult::Unhandled);

    MainWin         &mw     = GetMainWin();
    enumToolResult  eReturn = enumToolResult::Unhandled;

    if (MU<u64>::AreBitsSet(GetToolBaseFunction(), TBF_WHEEL_ZOOM))
    {

    //     // transform the click position to zoom of the owner view
    //     qVector2D<s32> v2dZoom_pic = pView->Client2Pic(_v2dLocal);
...
enumToolResult ToolBase::OnLMousePress(u32                  _u32Modifiers,
                                       ...
                                       const qVector2D<s32> &_v2dGlobal)
{
    enumToolResult  eReturn = qToolBase::OnLMousePress(_u32Modifiers, _v2dLocal, _v2dGlobal);
...
enumToolResult ToolBase::OnLMouseMove(u32                   _u32Modifiers,
                                      ...
                                      const qVector2D<s32>  &_v2dGlobal)
{
    enumToolResult  eReturn = qToolBase::OnLMouseMove(_u32Modifiers, _v2dLocal, _v2dGlobal);
...
enumToolResult ToolBase::OnLMouseRelease(u32                _u32Modifiers,
                                      ...
                                      const qVector2D<s32> &_v2dGlobal)
{
    enumToolResult  eReturn = qToolBase::OnLMouseRelease(_u32Modifiers, _v2dLocal, _v2dGlobal);
...
enumToolResult ToolBase::OnMMousePress(u32                  _u32Modifiers,
                                       ...
                                       const qVector2D<s32> &_v2dGlobal)
{
    enumToolResult  eReturn = qToolBase::OnMMousePress(_u32Modifiers, _v2dLocal, _v2dGlobal);
...
enumToolResult ToolBase::OnMMouseRelease(u32                  _u32Modifiers,
                                         ...
                                         const qVector2D<s32> &_v2dGlobal)
{
    enumToolResult  eReturn = qToolBase::OnMMouseRelease(_u32Modifiers, _v2dLocal, _v2dGlobal);
