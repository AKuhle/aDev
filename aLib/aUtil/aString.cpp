...
*******************************************************************************/
#include "aString.h"
#include "aUtil/Collection/aVector.h"
...
* aString::from_value
*******************************************************************************/
aString aString::from_value(s8 _s8Val)
{
...
* aString::from_value
*******************************************************************************/
aString aString::from_value(s16 _s16Val)
{
...
* aString::from_value
*******************************************************************************/
aString aString::from_value(s32 _s32Val)
{
...
* aString::from_value
*******************************************************************************/
aString aString::from_value(s64 _s64Val)
{
...
* aString::from_value
*******************************************************************************/
aString aString::from_value(u8 _u8Val)
{
...
* aString::from_value
*******************************************************************************/
aString aString::from_value(u16 _u16Val)
{
...
* aString::from_value
*******************************************************************************/
aString aString::from_value(u32 _u32Val)
{
...
* aString::from_value
*******************************************************************************/
aString aString::from_value(u64 _u64Val)
{
...
* aString::from_value
*******************************************************************************/
aString aString::from_value(flt _fVal)
{
...
* aString::from_value
*******************************************************************************/
aString aString::from_value(dbl _dVal)
{
...
* aString::from_value
*******************************************************************************/
aString aString::from_value(ldbl _ldVal)
{
                          ...
                          aVector<aString>   &_vecToken) const
{
...
#ifdef _USE_QT_
    /*******************************************************************************
    * aString::from_QString
    *******************************************************************************/
    aString aString::from_QString(const QString &_str)
    {
    ...
    * aString::to_QString
    *******************************************************************************/
    QString aString::to_QString() const
    {
