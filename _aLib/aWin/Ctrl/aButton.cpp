...
/*******************************************************************************
* aButton::setSelectedColor
*******************************************************************************/
void aButton::setSelectedColor(const aColor  &_color)
{
...
/*******************************************************************************
* aButton::selectedColor
*******************************************************************************/
const aColor& aButton::selectedColor() const
{
...
* aButton::stateColor
*******************************************************************************/
aColor aButton::stateColor() const
{
    if (!isEnabled())
    {
        // disabled
    ...
    else
    {
        if (isHover())
        {
            if (isSelected())
            {
                // hover && selected => selected color
                return selectedColor();
            }
            else
            {
                // hover && !selected => hover color
                return hoverColor();
            }
        } // if (isHover())
        else
        {
            ...
            {
                // !hover && !selected => normal color
                return normalColor();
            }
        } // if (isHover())
    }
} // setSelectable::stateColor
