...
class RenderParams
{
    ...
    *******************************************************************************/
    ...
    private:
        ...
        shared_ptr<aLayerStack> m_pLayerStack;
    ...
    *******************************************************************************/
    public:
        // 1. layer stack
        shared_ptr<aLayerStack>     layerStack() const;
        void						setLayerStack(shared_ptr<aLayerStack> _pLayerStack);
    ...
    public:
        ...
        aDimension2D<s32>           zoomedDimension() const;
        s32                         zoomedW() const;
        s32                         zoomedH() const;
